...
<div class="list-post">
    <article id="post-<?php esc_attr(the_ID()); ?>" <?php post_class(); ?>>
						...
						<div class="slick-carousel" data-columns4="1" data-columns3="1" data-columns2="1" data-columns1="1" data-columns="1" data-nav="true">
								<?php
									if($ids){
										...
										foreach ( $ids as $i => $id ){ ?>
											<div class="item">
													<?php echo wp_get_attachment_image($id, 'hanata-full-width'); ?>
											</div>
										<?php }	
									}
								?>
		...
		<div class="post-content">
        	...
        	<?php hanata_posted_on(); ?>
        	<?php
        		if (hanata_get_config('blog-excerpt')) {
                    echo hanata_get_excerpt( hanata_get_config('list-blog-excerpt-length',30), false);
                }
			?>
