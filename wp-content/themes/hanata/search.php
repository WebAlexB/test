...
<div class="container">
	<div class="category-posts row">
		...
		<?php endif; ?>			
		<div class="cate-post-content <?php if(is_active_sidebar('sidebar-blog')){ echo esc_attr(hanata_get_class()->class_blog_content); }else{ echo "col-lg-12 col-md-12 col-sm-12 col-xs-12"; } ?>">
