...
<form class="cart" method="post" enctype='multipart/form-data'>
	<table cellspacing="0" class="group_table">
		<tbody>
			<tr>
				<th><span><?php echo esc_html__("Image","hanata"); ?></span></th>
				<th><span><?php echo esc_html__("Product Name","hanata"); ?></span></th>
				<th><span><?php echo esc_html__("Price","hanata"); ?></span></th>
				<th><span><?php echo esc_html__("Qty","hanata"); ?></span></th>
			</tr>		
			<?php
