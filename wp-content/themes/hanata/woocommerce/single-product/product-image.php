...
if(hanata_image_single_product()->product_layout_thumb == "scroll") 
	wc_get_template( 'single-product/content-image/scroll.php' );
elseif(hanata_image_single_product()->product_layout_thumb == "list")
	wc_get_template( 'single-product/content-image/list.php' );
elseif(hanata_image_single_product()->product_layout_thumb == "list2")
